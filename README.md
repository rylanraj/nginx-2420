...
Once you have done this, use sudo systemctl reload nginx. Then open your browser and enter in your droplet’s IP address. If you did everything correct, you should see your webpage. Note: GitHub is optional, once you create the webpage, it should be able to view at your droplet's IP address as soon as you reload nginx.
